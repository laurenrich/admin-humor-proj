...
export async function createWhitelistedEmail(formData: FormData): Promise<ActionResult> {
  try {
...
export async function updateWhitelistedEmail(formData: FormData): Promise<ActionResult> {
  try {
    const res = await requireSuperadmin();
    if (!res.ok) return err("Not authorized");
...
export async function deleteWhitelistedEmail(formData: FormData): Promise<ActionResult> {
  try {
    const res = await requireSuperadmin();
    if (!res.ok) return err("Not authorized");

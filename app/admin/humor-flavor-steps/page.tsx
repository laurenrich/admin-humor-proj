  ...
  if (!table) {
    return (
      <div className="flex flex-col gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Humor flavor steps</h1>
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Humor flavor steps</h1>
        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
          Read-only view of <span className="font-mono">`{table}`</span>. Showing up to{" "}
          {PAGE_SIZE}.
        </p>
      </div>
                  ...
                  {columns.map((c) => {
                    ...
                    return (
                      <td key={c} className="px-4 py-3 text-zinc-700 dark:text-zinc-300">
                        ...
                        >
                          <div
                            className={isIdCol ? "" : isLong ? "max-w-[480px] truncate" : ""}

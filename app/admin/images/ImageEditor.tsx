    ...
    <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-900 dark:bg-zinc-950">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex min-w-0 items-start gap-4">
          <div className="h-20 w-20 overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-50 dark:border-zinc-900 dark:bg-zinc-900/30">
            {hasPreview ? (
      ...
      {editing ? (
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 text-sm text-zinc-700 dark:text-zinc-300 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2 rounded-2xl border border-zinc-200 p-4 dark:border-zinc-900">
            <div className="text-xs font-medium text-zinc-500 dark:text-zinc-400">
              Celebrity recognition
            </div>
            <div className="mt-2 whitespace-pre-wrap">

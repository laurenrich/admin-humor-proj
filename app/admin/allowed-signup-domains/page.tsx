...
export default async function AdminAllowedSignupDomainsPage() {
  ...
  if (!table) {
    return (
      <div className="flex flex-col gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Allowed signup domains</h1>
  ...
  return (
    <CrudClient
      ...
      pagePath="/admin/allowed-signup-domains"
      table={table}
      rows={rows}
      preferredColumns={preferred}
      createAction={createAllowedSignupDomain}
      updateAction={updateAllowedSignupDomain}
      deleteAction={deleteAllowedSignupDomain}
    />
  );
}
